...
## About me
Driven by a strong passion for using data and technology to drive positive transformations, my professional journey is guided by curiosity and a deep-seated belief in the power of innovation to address environmental, social, and economic challenges of our time. As a Program Manager for Data & Innovations and a former management consultant at PwC, I've had the privilege to work on transformative projects that harness the potential of data and technology in an international and multicultural context. Whether it's designing data platforms to enhance healthcare access in rural Kenya or facilitate civil service reforms in pre-conflict Sudan or collect and visualize data from the world's forests, my work is fueled by a relentless commitment to making a meaningful impact. My multifaceted background in Industrial Engineering, Accounting, Business, and data science, coupled with certifications as a PMI Project Management Professional (PMP) and in Business Analytics, equips me to wear multiple hats as an innovator, a product and project manager, a business leader, and a technology thought leader.
